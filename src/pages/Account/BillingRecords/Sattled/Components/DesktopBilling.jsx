      ...
      <div className="m-6">
        <div className="hidden md:block bg-gray-700 text-white p-4 rounded-md shadow-lg">
          ...
          <div className="mb-4 border-b border-dashed border-yellow-500 pb-2">
            <h2 className="text-yellow-400 font-semibold"> <span className="text-2xl">|</span> Betting Records</h2>
          </div>
          ...
          {/* Platform */}
          <div className="mb-6">
            <p className="text-sm mb-2">Platform</p>
          ...
          {/* Game Type */}
          <div className="mb-6">
            <p className="text-sm mb-2">Game Type</p>
            <div className="grid grid-cols-6 gap-2">
              {gameTypes.map((g) =>
